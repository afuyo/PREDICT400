...
print '6a. Find A intersection B: %r'%(A&B)
print '6b. Find A intersection B`: %r'%(A&(U-B))
...
print '7a Find A union B: %r'%(A|B)
print '7b Find (A union B) intersection C`: %r'%((A|B)&(U-C))
